...
static const t_err_msg		g_err_msg[] = {
	...
	{NO_PHILO, "No philosopher at all ? Should i wait an eternity before you\
realise there is only void waiting for you ? Try with a value greater than 0"},
	{NO_VALUE, "There is an empty argument here.\
Try with a positive number next time"},
	...
	{ITS_GOOD_DONT_WORRY, "normalement ce message ne sera jamais utilisé"},
	{0, NULL}
};
